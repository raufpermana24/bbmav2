        ...
        try:
            ...
            for alert in alerts_queue:
                ...
                if processed_signals.get(sig_key) != alert['time']:
                    ...
                    print(f"🔥 Sinyal: {sym} -> {alert['signal']} (Vol {alert['spike_ratio']:.1f}x)")
