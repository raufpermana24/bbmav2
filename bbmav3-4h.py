...
def generate_chart(df, symbol, signal_info):
    try:
        ...
        title_text = f"{symbol} [4H] - Vol {signal_info['spike_ratio']:.1f}x - {signal_info['bb_status']}"
...
# ==========================================
def main():
    print(f"=== VOLUME HUNTER 4H + BBMA BOT (v2 Updated) ===")
    print(f"Strategi: Cari Volume Spike > {VOL_MULTIPLIER}x di TF 4H.")
