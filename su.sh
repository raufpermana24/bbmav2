sudo su
sudo apt install npm -y && npm install pm2 -g && pip install ccxt pandas pandas_ta && pip install ccxt pandas numpy colorama && pip install ccxt pandas pandas_ta mplfinance requests
cd bbmav1 
cd bbmav1
